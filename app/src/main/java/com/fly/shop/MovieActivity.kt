...
class MovieActivity : AppCompatActivity(),AnkoLogger {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        doAsync {
//            val json = URL("https://api.myjson.com/bins/111kb8").readText()
//            movies = Gson().fromJson<List<Movie>>(json, object : TypeToken<List<Movie>>(){}.type)
    ...
    inner class MovieAdapter : RecyclerView.Adapter<MovieAdapter.MovieHolder>(){
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MovieHolder {
            val view = LayoutInflater.from(this@MovieActivity).inflate(R.layout.row_movie, parent, false)
